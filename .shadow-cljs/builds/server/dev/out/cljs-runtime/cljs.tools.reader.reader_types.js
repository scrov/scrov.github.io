...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_11764 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_11764(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_11765 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_11765(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_11766 = (function (reader,ch){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_11766(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_11767 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_11767(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_11768 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_11768(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_11769 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_11769(reader);
}
});
...
var G__11785 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__11786 = s.append(c);
c = G__11785;
s = G__11786;
continue;
}
