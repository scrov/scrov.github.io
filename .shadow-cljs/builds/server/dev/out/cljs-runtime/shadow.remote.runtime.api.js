...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_11876 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_11876(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_11878 = (function (runtime,key,spec){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_11878(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_11880 = (function (runtime,key){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_11880(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_11882 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_11882(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_11887 = (function (runtime,input,callback){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_11887(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_11889 = (function (runtime,code,success,fail){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_11889(runtime,code,success,fail);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__11866,callback){
var map__11867 = p__11866;
var map__11867__$1 = cljs.core.__destructure_map(map__11867);
var input = map__11867__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11867__$1,new cljs.core.Keyword(null,"code","code",1586293142));
