...
*/
promesa.exec.t_promesa$exec28660 = (function (meta28661){
this.meta28661 = meta28661;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(promesa.exec.t_promesa$exec28660.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_28662,meta28661__$1){
var self__ = this;
var _28662__$1 = this;
return (new promesa.exec.t_promesa$exec28660(meta28661__$1));
}));

(promesa.exec.t_promesa$exec28660.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_28662){
var self__ = this;
var _28662__$1 = this;
return self__.meta28661;
}));

(promesa.exec.t_promesa$exec28660.prototype.promesa$protocols$IExecutor$ = cljs.core.PROTOCOL_SENTINEL);

(promesa.exec.t_promesa$exec28660.prototype.promesa$protocols$IExecutor$_exec_BANG_$arity$2 = (function (this$,f){
var self__ = this;
var this$__$1 = this;
try{(f.cljs$core$IFn$_invoke$arity$0 ? f.cljs$core$IFn$_invoke$arity$0() : f.call(null));

return null;
}catch (e28664){var _ = e28664;
return null;
}}));

(promesa.exec.t_promesa$exec28660.prototype.promesa$protocols$IExecutor$_run_BANG_$arity$2 = (function (this$,f){
var self__ = this;
var this$__$1 = this;
try{return promesa.protocols._promise(cljs.core.comp.cljs$core$IFn$_invoke$arity$2(promesa.exec.noop,f));
}catch (e28665){var cause = e28665;
return promesa.protocols._promise(cause);
}}));

(promesa.exec.t_promesa$exec28660.prototype.promesa$protocols$IExecutor$_submit_BANG_$arity$2 = (function (this$,f){
var self__ = this;
var this$__$1 = this;
try{return promesa.protocols._promise((f.cljs$core$IFn$_invoke$arity$0 ? f.cljs$core$IFn$_invoke$arity$0() : f.call(null)));
}catch (e28667){var cause = e28667;
return promesa.protocols._promise(cause);
}}));

(promesa.exec.t_promesa$exec28660.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta28661","meta28661",-1759008821,null)], null);
}));

(promesa.exec.t_promesa$exec28660.cljs$lang$type = true);

(promesa.exec.t_promesa$exec28660.cljs$lang$ctorStr = "promesa.exec/t_promesa$exec28660");

(promesa.exec.t_promesa$exec28660.cljs$lang$ctorPrWriter = (function (this__5287__auto__,writer__5288__auto__,opt__5289__auto__){
return cljs.core._write(writer__5288__auto__,"promesa.exec/t_promesa$exec28660");
}));

/**
 * Positional factory function for promesa.exec/t_promesa$exec28660.
 */
promesa.exec.__GT_t_promesa$exec28660 = (function promesa$exec$__GT_t_promesa$exec28660(meta28661){
return (new promesa.exec.t_promesa$exec28660(meta28661));
});
...
return (new promesa.exec.t_promesa$exec28660(cljs.core.PersistentArrayMap.EMPTY));
});
 ...
 * @implements {cljs.core.IWithMeta}
*/
promesa.exec.t_promesa$exec28668 = (function (meta28669){
this.meta28669 = meta28669;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(promesa.exec.t_promesa$exec28668.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_28670,meta28669__$1){
var self__ = this;
var _28670__$1 = this;
return (new promesa.exec.t_promesa$exec28668(meta28669__$1));
}));

(promesa.exec.t_promesa$exec28668.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_28670){
var self__ = this;
var _28670__$1 = this;
return self__.meta28669;
}));

(promesa.exec.t_promesa$exec28668.prototype.promesa$protocols$IExecutor$ = cljs.core.PROTOCOL_SENTINEL);

(promesa.exec.t_promesa$exec28668.prototype.promesa$protocols$IExecutor$_exec_BANG_$arity$2 = (function (this$,f){
var self__ = this;
var this$__$1 = this;
return promesa.impl.promise.nextTick(f);
}));

(promesa.exec.t_promesa$exec28668.prototype.promesa$protocols$IExecutor$_run_BANG_$arity$2 = (function (this$,f){
var self__ = this;
var this$__$1 = this;
return promesa.protocols._fmap(promesa.protocols._fmap(promesa.protocols._promise(null),(function (_){
try{return (f.cljs$core$IFn$_invoke$arity$0 ? f.cljs$core$IFn$_invoke$arity$0() : f.call(null));
}catch (e28673){var ___$1 = e28673;
return null;
}})),promesa.exec.noop);
}));

(promesa.exec.t_promesa$exec28668.prototype.promesa$protocols$IExecutor$_submit_BANG_$arity$2 = (function (this$,f){
var self__ = this;
var this$__$1 = this;
...
(promesa.exec.t_promesa$exec28668.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta28669","meta28669",-1680649469,null)], null);
}));

(promesa.exec.t_promesa$exec28668.cljs$lang$type = true);

(promesa.exec.t_promesa$exec28668.cljs$lang$ctorStr = "promesa.exec/t_promesa$exec28668");

(promesa.exec.t_promesa$exec28668.cljs$lang$ctorPrWriter = (function (this__5287__auto__,writer__5288__auto__,opt__5289__auto__){
return cljs.core._write(writer__5288__auto__,"promesa.exec/t_promesa$exec28668");
}));

/**
 * Positional factory function for promesa.exec/t_promesa$exec28668.
 */
promesa.exec.__GT_t_promesa$exec28668 = (function promesa$exec$__GT_t_promesa$exec28668(meta28669){
return (new promesa.exec.t_promesa$exec28668(meta28669));
});
...
return (new promesa.exec.t_promesa$exec28668(cljs.core.PersistentArrayMap.EMPTY));
});
...
var len__5726__auto___28710 = arguments.length;
var i__5727__auto___28711 = (0);
while(true){
if((i__5727__auto___28711 < len__5726__auto___28710)){
args__5732__auto__.push((arguments[i__5727__auto___28711]));

var G__28712 = (i__5727__auto___28711 + (1));
i__5727__auto___28711 = G__28712;
continue;
} else {
}
break;
...
(promesa.exec.scheduled_executor.cljs$core$IFn$_invoke$arity$variadic = (function (p__28680){
var map__28681 = p__28680;
var map__28681__$1 = cljs.core.__destructure_map(map__28681);
var parallelism = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__28681__$1,new cljs.core.Keyword(null,"parallelism","parallelism",-930922333),(1));
var factory = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28681__$1,new cljs.core.Keyword(null,"factory","factory",63933746));
...
/** @this {Function} */
(promesa.exec.scheduled_executor.cljs$lang$applyTo = (function (seq28679){
var self__5712__auto__ = this;
return self__5712__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq28679));
}));
