shadow$provide.module$node_modules$react_dom$cjs$react_dom_client_development = function(global, require, module, exports) {
  ...
  (function() {
    ...
    function getValueForAttributeOnCustomComponent(node, name, expected) {
      if (isAttributeNameSafe(name)) {
        ...
        return "" === node && !0 === expected ? !0 : node === "" + expected ? expected : node;
      }
    }
      ...
      if (null != value$jscomp$0 && "object" !== typeof value$jscomp$0) {
        ...
        for (styleName in value$jscomp$0) {
          if (value$jscomp$0.hasOwnProperty(styleName)) {
            ...
            null != value && "boolean" !== typeof value && "" !== value && (0 === styleName.indexOf("--") ? clientValue += delimiter + styleName + ":" + ("" + value).trim() : "number" !== typeof value || 0 === value || unitlessNumbers.has(styleName) ? clientValue += delimiter + styleName.replace(uppercasePattern, "-$1").toLowerCase().replace(msPattern$1, "-ms-") + ":" + ("" + value).trim() : clientValue += delimiter + styleName.replace(uppercasePattern, "-$1").toLowerCase().replace(msPattern$1, "-ms-") + 
            ":" + value + "px", delimiter = ";");
          }
        }
      ...
      if (null === domElement) {
        ...
        switch(typeof value) {
          ...
          case "boolean":
            break;
          default:
            if (!isNaN(value) && domElement === "" + value) {
              return;
            }
        }
      }
      ...
      if (null === domElement) {
        ...
        switch(typeof value) {
          ...
          case "boolean":
            break;
          default:
            if (attributeName = sanitizeURL("" + value), domElement === attributeName) {
              return;
            }
        }
      }
                    ...
                    if (null === i) {
                      ...
                      switch(typeof propKey) {
                        ...
                        case "boolean":
                          break;
                        default:
                          if (!(isNaN(propKey) || 1 > propKey) && i === "" + propKey) {
                            break a;
                          }
                      }
                    }
                    ...
                    a: {
                      if (attributeName = domElement, serverDifferences$jscomp$0 = i, i = propKey, isAttributeNameSafe(serverDifferences$jscomp$0)) {
                        if (attributeName.hasAttribute(serverDifferences$jscomp$0)) {
                          attributeName = attributeName.getAttribute(serverDifferences$jscomp$0), i = attributeName === "" + i ? i : attributeName;
                        } else {
                          switch(typeof i) {
                            case "function":
                            case "symbol":
    ...
    if (!function() {
      var internals = {bundleType:1, version:"19.2.8", rendererPackageName:"react-dom", currentDispatcherRef:ReactSharedInternals, reconcilerVersion:"19.2.8"};
