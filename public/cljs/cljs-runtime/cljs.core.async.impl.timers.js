...
var i_21874 = (0);
while(true){
if((i_21874 < arr.length)){
(arr[i_21874] = null);

var G__21875 = (i_21874 + (1));
i_21874 = G__21875;
continue;
} else {
}
...
var i_21882 = (self__.level + (1));
while(true){
if((i_21882 <= (new_level + (1)))){
(update[i_21882] = self__.header);

var G__21883 = (i_21882 + (1));
i_21882 = G__21883;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_21884 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_21884[i]));
} else {
x__$2.forward.push((((i < links_21884.length))?(links_21884[i]):null));
}

if((i < links_21884.length)){
(links_21884[i] = x__$2);
} else {
links_21884.push(x__$2);
}
...
var i_21888 = (0);
while(true){
if((i_21888 <= self__.level)){
var links_21889 = (update[i_21888]).forward;
if((x__$1 === (((i_21888 < links_21889.length))?(links_21889[i_21888]):null))){
(links_21889[i_21888] = (x__$1.forward[i_21888]));
...
if(cljs.core.truth_(nx)){
var G__21900 = nx;
var G__21901 = (level__$1 - (1));
x = G__21900;
level__$1 = G__21901;
continue;
} else {
var G__21902 = x;
var G__21903 = (level__$1 - (1));
x = G__21902;
level__$1 = G__21903;
continue;
}
