...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_21786 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_21786(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_21788 = (function (runtime,key,spec){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_21788(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_21799 = (function (runtime,key){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_21799(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_21811 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_21811(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_21816 = (function (runtime,input,callback){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_21816(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_21820 = (function (runtime,code,success,fail){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_21820(runtime,code,success,fail);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__21776,callback){
var map__21779 = p__21776;
var map__21779__$1 = cljs.core.__destructure_map(map__21779);
var input = map__21779__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21779__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21779__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
